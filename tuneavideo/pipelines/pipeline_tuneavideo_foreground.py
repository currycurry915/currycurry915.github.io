        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                ptp_utils_foreground.register_attention_control(forward_list, backward_list, fore_ground_list, self, controller)
                ...
                if i==49:
                    attention_maps = attention_maps[:, :, :,3].detach()
                    print("attention_maps.shape",attention_maps.shape)
                    resize = transforms.Resize(64)
                    attention_maps = resize(attention_maps)

                    # only for save attn
                    for k in range(8):
                        image = attention_maps[k]
                        ...
                        image.save('/database/jih/ne_sw_bus_tune/attn_'+str(k).zfill(3)+'.png', 'png')
