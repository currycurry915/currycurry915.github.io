...
def register_attention_control(forward_list, backward_list, model, controller):
    def ca_forward(self, place_in_unet):
        ...
        def forward(x, encoder_hidden_states=None, attention_mask=None):
            ...
            if 'DummyController' in str(controller):
                attn = controller(attn, is_cross, place_in_unet)
            else:
                attn = controller(forward_list, backward_list, attn, is_cross, place_in_unet)
